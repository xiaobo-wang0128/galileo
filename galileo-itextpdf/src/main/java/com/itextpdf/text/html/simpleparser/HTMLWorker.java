...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener {
	...
	private static Logger LOGGER = LoggerFactory.getLogger("applicationLogger");
	/**
    ...
    /**
     * @see SimpleXMLDocHandler#startElement(java.lang.String, java.util.Map)
     */
	...
	/**
	 * @see SimpleXMLDocHandler#text(java.lang.String)
	 */
	...
	/**
	 * @see SimpleXMLDocHandler#endElement(java.lang.String)
	 */
	...
	/**
	 * @see com.itextpdf.text.ElementListener#add(Element)
	 */
	...
	/**
	 * @see DocListener#close()
	 */
	public void close() {
	}

	/**
	 * @see DocListener#newPage()
	 */
	...
	/**
	 * @see DocListener#open()
	 */
	public void open() {
	}

	/**
	 * @see DocListener#resetPageCount()
	 */
	...
	/**
	 * @see DocListener#setMargins(float, float, float, float)
	 */
	...
	/**
	 * @see DocListener#setPageCount(int)
	 */
	public void setPageCount(final int pageN) {
	}

	/**
	 * @see DocListener#setPageSize(Rectangle)
	 */
