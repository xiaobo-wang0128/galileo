        ...
        if (null != rules.get(CSS.Property.TEXT_DECORATION)) {
            ...
            for (String value : splitValues) {
                if (CSS.Value.UNDERLINE.equalsIgnoreCase(value)) {
                	...
                	c.setUnderline(BaseColor.BLACK, 0.2f, 0, -3, -0.125f, PdfContentByte.LINE_CAP_BUTT);
                }
                if (CSS.Value.LINE_THROUGH.equalsIgnoreCase(value)) {
                    c.setUnderline(BaseColor.BLACK, 0.75f, 0, 0, 0.25f, PdfContentByte.LINE_CAP_BUTT);
                }
            }
        }
