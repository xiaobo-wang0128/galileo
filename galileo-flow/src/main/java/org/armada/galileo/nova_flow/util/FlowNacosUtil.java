...
public class FlowNacosUtil {
    ...
    public FlowNacosUtil(String serverAddr, String configFileHeader) {
        ...
        this.configFileId = configFileHeader + "_nova_flow_config.json";

        this.configGroup = "nova_flow";
    }
