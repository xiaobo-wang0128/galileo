...
//
////代码基于docx4j-3.2.0
//public class Docx4jWebUtil {
//
//    /*------------------------------------other---------------------------------------------------  */
//    /**
//     * @Description:新增超链接
//     */
//    public static void createHyperlink(WordprocessingMLPackage wordMLPackage, MainDocumentPart mainPart, ObjectFactory factory, P paragraph, String url, String value, String cnFontName, String enFontName, String fontSize) throws Exception {
...
//     */
//    public static WordprocessingMLPackage loadWordprocessingMLPackageWithPwd(String filePath, String password) throws Exception {
...
//     */
//    public static void setTblBorders(TblPr tblPr, CTBorder topBorder, CTBorder rightBorder, CTBorder bottomBorder, CTBorder leftBorder, CTBorder hBorder, CTBorder vBorder) {
...
//     * @Description: 添加图片到段落
//     */
//    public static void addImageToPara(WordprocessingMLPackage wordMLPackage, ObjectFactory factory, P paragraph, String filePath, String content, RPr rpr, String altText, int id1, int id2) throws Exception {
...
//     */
//    public static void setParagraphSpacing(P p, boolean isSpace, String before, String after, String beforeLines, String afterLines, boolean isLine, String lineValue, STLineSpacingRule sTLineSpacingRule) {
//        PPr pPr = getPPr(p);
...
//     */
//    public static void setParagraphIndInfo(P p, String firstLine, String firstLineChar, String hanging, String hangingChar, String right, String rigthChar, String left, String leftChar) {
//        PPr ppr = getPPr(p);
//        Ind ind = ppr.getInd();
//        if (ind == null) {
//            ind = new Ind();
...
//     */
//    public static void setParagraghBorders(P p, CTBorder topBorder, CTBorder bottomBorder, CTBorder leftBorder, CTBorder rightBorder) {
//        PPr ppr = getPPr(p);
//        PBdr pBdr = new PBdr();
//        if (topBorder != null) {
...
//     * @Description: 设置字体信息
//     */
//    public static void setFontStyle(RPr runProperties, String cnFontFamily, String enFontFamily, String fontSize, String color) {
...
//     * @Description: 设置页面背景色
//     */
//    public static void setDocumentBackGround(WordprocessingMLPackage wordPackage, ObjectFactory factory, String color) throws Exception {
...
//     * @Description: 设置页面边框
//     */
//    public static void setDocumentBorders(WordprocessingMLPackage wordPackage, ObjectFactory factory, CTBorder top, CTBorder right, CTBorder bottom, CTBorder left) {
//        SectPr sectPr = getDocSectPr(wordPackage);
...
//     * @Description：设置页边距
//     */
//    public static void setDocMarginSpace(WordprocessingMLPackage wordPackage, ObjectFactory factory, int top, int right, int bottom, int left) {
//        SectPr sectPr = getDocSectPr(wordPackage);
...
//
//        if (top > 0) {
//            pg.setTop(BigInteger.valueOf(top));
//        }
//        if (bottom > 0) {
//            pg.setBottom(BigInteger.valueOf(bottom));
//        }
//        if (left > 0) {
//            pg.setLeft(BigInteger.valueOf(left));
//        }
//        if (right > 0) {
//            pg.setRight(BigInteger.valueOf(right));
//        }
//
//    }
//
...
//     */
//    public static void setDocInNumType(WordprocessingMLPackage wordPackage, String countBy, String distance, String start, STLineNumberRestart restartType) {
//        SectPr sectPr = getDocSectPr(wordPackage);
