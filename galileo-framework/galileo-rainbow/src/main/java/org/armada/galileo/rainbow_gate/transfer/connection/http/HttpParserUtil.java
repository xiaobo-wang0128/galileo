...
public class HttpParserUtil {
	...
	public static HttpPostParam parseRequestData(HttpServletRequest request) throws Exception {
		...
		HttpPostParam httpPostParam = new HttpPostParam(appId, sign, dc, bufs);
		httpPostParam.setUserId(userId);
		httpPostParam.setToken(token);
