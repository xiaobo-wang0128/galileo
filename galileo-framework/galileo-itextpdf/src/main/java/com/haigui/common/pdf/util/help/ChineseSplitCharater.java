...
public class ChineseSplitCharater implements SplitCharacter {
	...
	static final char[] NOT_BEGIN_CHARACTERS = new char[] { u30fb, u2022, uff65, u300d, uff09, u0021, u0025, u0029, u002c, u002e, u003f, u005d, u007d, uff61, uff70, uff9e, uff9f, u3001, u3002, uff0c, uff0e, uff1a, uff1b, uff1f, uff01, u309b, u309c, u30fd, u2019, u201d, u3015, uff3d, uff5d, u3009, u300b, u300f, u3011, u00b0, u2032, u2033, u2060 };
	...
	static final char[] NOT_ENDING_CHARACTERS = new char[] { u0024, u0028, u005b, u007b, u00a3, u00a5, u201c, u2018, u3008, u300a, u300c, u300e, u3010, u3014, uff62, uff08, uff3b, uff5b, uffe5, uff04, u2060 };
	...
	/**
	 * Custom method to for SplitCharacter to handle Japanese characters. Returns <CODE>true</CODE> if the character can split a line. The splitting implementation is free to look ahead or look behind characters to make a decision.
	 *
	 ...
	 * @param ck an array of <CODE>PdfChunk</CODE>. The main use is to be able to call {@link PdfChunk#getUnicodeEquivalent(int)}. It may be <CODE>null</CODE> or shorter than <CODE>end</CODE>. If <CODE>null</CODE> no conversion takes place. If shorter than <CODE>end</CODE> the last element is used
	...
	/**
	 * Returns a character int the array (Note: modified from the iText default version with the addition null check of '|| ck[Math.min(position, ck.length - 1)] == null'.
	 *
