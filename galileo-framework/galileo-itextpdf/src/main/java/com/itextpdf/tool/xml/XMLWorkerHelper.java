...
import com.haigui.common.pdf.util.help.ConfigLoader;
...
public class XMLWorkerHelper {
	...
	public synchronized CssFile getDefaultCSS() {
		if (null == defaultCssFile) {
			defaultCssFile = getCSS(ConfigLoader.loadResource("default.css", false, false));
		}
	...
	public void parseXHtml(final PdfWriter writer, final Document doc, final InputStream in) throws IOException {
		parseXHtml(writer, doc, in, ConfigLoader.loadResource("default.css", false, false), null, new XMLWorkerFontProvider());
	}
	...
	public void parseXHtml(PdfWriter writer, Document doc, InputStream in, Charset charset, final FontProvider fontProvider) throws IOException {
		this.parseXHtml(writer, doc, in, ConfigLoader.loadResource("default.css", false, false), charset, fontProvider);
	}
	...
	public void parseXHtml(final PdfWriter writer, final Document doc, final InputStream in, final Charset charset) throws IOException {
		parseXHtml(writer, doc, in, ConfigLoader.loadResource("default.css", false, false), charset);
	}
	...
	/**
	 * Retrieves the default factory for processing HTML tags from {@link Tags#getHtmlTagProcessorFactory()}. On subsequent calls the same {@link TagProcessorFactory} is returned every time. <br />
	 * 
