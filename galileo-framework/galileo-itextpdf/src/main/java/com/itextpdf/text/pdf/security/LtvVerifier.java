...
public class LtvVerifier extends RootStoreVerifier {
	/** The Logger instance */
	protected final static Logger LOGGER = LoggerFactory.getLogger("applicationLogger");
	 ...
	 * @throws GeneralSecurityException
	 * @throws IOException
	 * @see RootStoreVerifier#verify(java.security.cert.X509Certificate, java.security.cert.X509Certificate)
	 */
