...
public class CodeScanVue {
    ...
    public static void main(String[] args) {
         ...
         String folder = "/Users/wangxiaobo/project/_codes/aml_2022/iml_mall/mall_front/pc_platform";
...
//        String folder = "/Users/wangxiaobo/project/_codes/aml_2022/galileo";
    ...
    public static void checkCodeRows(JavaFile f) {
        ...
        if(f.getFile().getAbsolutePath().indexOf("node_modules")!=-1){
            return;
        }


        if (f.getFile().getName().endsWith(".vue")
                || f.getFile().getName().endsWith(".js")
                || f.getFile().getName().endsWith(".css")
                || f.getFile().getName().endsWith(".scss")
        ) {
