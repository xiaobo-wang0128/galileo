 ...
 */
@Slf4j
@FlowActionImpl( name="扩展实现1", desc="用于测试1 CreateInboundAction1")
public class CreateInboundAction1 {
	...
	public String execute(Action action, InboundOrderDTO inboundOrderDTO) {
		System.out.println("CreateInboundAction1.execute");

		return "CreateInboundAction1";
	}
